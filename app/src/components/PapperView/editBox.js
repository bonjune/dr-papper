	...
	render() {
        ...
        <Row>
          ...
          <Col xs="7" style={{margin:"15px"}}>
            ...
            <Row style={{height:"140px", marginTop:"10px"}}>
              <div className="form-control-lg" style={{border: "0px", fontSize:"1.25rem", marginBottom:"8px", overflowY:"auto", wordBreak:"break-word", height:"100%"}}>{this.props.content}</div>
            </Row>
          </Col>
        </Row>
    	</div>
